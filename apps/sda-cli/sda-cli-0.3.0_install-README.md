...
Structure creating script (makeroom_sda-cli_0.3.0.sh) moved to /sw/apps/sda-cli/makeroom_0.3.0.sh

LOG
---

    /home/bjornv/git/install-methods/makeroom.sh "-t" "sda-cli" "-v" "0.3.0" "-c" "apps" "-w" "https://github.com/NBISweden/sda-cli" "-l" "AGPL-3.0" "-L" "https://github.com/NBISweden/sda-cli/blob/main/LICENSE" "-d" "This is the Sensitive Data Archive (SDA) Command Line Interface (sda-cli)." "-f"
    ./makeroom_sda-cli_0.3.0.sh


```sh
# Download the sda-cli executable that matches your system from the GitHub repository.
wget https://github.com/NBISweden/sda-cli/releases/download/v${VERSION}/sda-cli_.${VERSION}_Linux_x86_64.tar.gz

# Extract the binary by using the tar command:
tar -xvzf sda-cli_.${VERSION}_Linux_x86_64.tar.gz
mkdir public_keys
cd public_keys 
