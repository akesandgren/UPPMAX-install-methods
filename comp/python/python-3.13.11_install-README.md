...
Structure creating script (makeroom_python_3.13.11.sh) moved to /sw/comp/python/makeroom_3.13.11.sh
...
---
    ...
    makeroom.sh "-t" "python" "-v" "3.13.11" "-c" "comp" "-w" "https://python.org/" "-l" "PSF License Agreement" "-L" "https://docs.python.org/3/license.html" "-d" "Python programming language plus a handful of widely used packages" "-f"
    ./makeroom_python_3.13.11.sh
    VERSION=3.13.11
    source /sw/comp/python/SOURCEME_python_${VERSION}
    cd $SRCDIR
...
Make sure the mf is correct. makeroom.sh can make a poor choice here.
    ...
    ./python-${VERSION}_post-install.sh
